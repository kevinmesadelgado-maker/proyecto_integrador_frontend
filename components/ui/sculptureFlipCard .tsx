...
import { sculpture } from '@/types/sculpture'; // La interfaz ya corregida

interface sculpFlipCardProps {
    item: sculpture;
}

export const SculptureFlipCard: React.FC<sculpFlipCardProps> = ({ item }) => {
    return (
