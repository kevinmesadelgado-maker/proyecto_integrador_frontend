...
import { pinturas } from '@/types/pinturas'; // La interfaz ya corregida

interface PinturaFlipCardProps {
    item: pinturas;
}

export const PinturaFlipCard: React.FC<PinturaFlipCardProps> = ({ item }) => {
    return (
